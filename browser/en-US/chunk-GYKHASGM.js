...
var ShowClientModalComponent = class _ShowClientModalComponent {
  constructor() {
    ...
    this.fullEditButtonString = "Full edit";
    ...
    this.ɵcmp = /* @__PURE__ */ɵɵdefineComponent({
      ...
      consts: () => {
        ...
        if (false) {
          ...
          i18n_0 = "Enter clients firstname";
        }
        let i18n_1;
        if (false) {
        ...
        if (false) {
          ...
          i18n_3 = "Enter clients phone number";
        }
        let i18n_4;
        if (false) {
