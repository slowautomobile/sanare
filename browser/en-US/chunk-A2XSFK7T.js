...
var LoginComponent = class _LoginComponent {
  ...
  onSubmitGuest() {
    this.usersService.loginAsGuest().subscribe({
      ...
      error: err => {
        this._snackBar.open("Too many login attempts. Try again in 15 minutes.", "", {
          duration: 2e3,
    ...
    this.ɵcmp = /* @__PURE__ */ɵɵdefineComponent({
      ...
      consts: () => {
        ...
        if (false) {
          ...
          i18n_9 = "Please enter a valid email address";
        }
        let i18n_10;
        if (false) {
