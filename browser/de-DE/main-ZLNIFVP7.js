...
// apps/sanare-app/src/app/app.component.ts
var AppComponent = class _AppComponent {
  constructor() {
    this.title = "sanare-app";
  }
  static {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["sanareapp-root"]], decls: 1, vars: 0, template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "apps/sanare-app/src/app/app.component.ts", lineNumber: 9 });
})();

// apps/sanare-app/src/app/app.routes.ts
var appRoutes = [
  {
    path: "",
    loadComponent: () => import("./chunk-VIGM5EID.js").then((m) => m.NavigationRailComponent),
    ...
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      {
        ...
        loadComponent: () => import("./chunk-G2NVIFL7.js").then((m) => m.DashboardComponent)
      },
      {
        path: "clients",
        title: "Clients \u2981 Sanare",
        loadComponent: () => import("./chunk-PQWT34PY.js").then((m) => m.ClientsListComponent)
      },
      {
        path: "clients/form",
        title: "Add client \u2981 Sanare",
        loadComponent: () => import("./chunk-W6F6L6UE.js").then((m) => m.ClientFormComponent)
      },
      {
        ...
        // {
        //   path: 'programs',
        //   component: ClientFullEditProgramsComponent,
        // },
        // {
        //   path: 'program/:id',
        //   component: NewProgramStepperComponent,
        // },
        // { path: 'notes', component: ClientFullEditFormComponent },
        // ],
      },
      {
        path: "exercise/:exerciseId",
        title: "Exercise \u2981 Sanare",
        loadComponent: () => import("./chunk-GI6QQO35.js").then((m) => m.FullExerciseComponent)
      },
      // { path: 'exercises', component: ExercisesListComponent },
      {
        path: "settings",
        title: "Settings \u2981 Sanare",
        loadComponent: () => import("./chunk-6XKQPIQ5.js").then((m) => m.SettingsComponent)
      },
      // { path: 'exercises/edit-program', component: EditProgramComponent },
      {
        path: "programs",
        title: "Programs \u2981 Sanare",
        loadComponent: () => import("./chunk-2YGBGWXH.js").then((m) => m.ProgramsListComponent)
      },
      {
        path: "programs/form",
        title: "Add program \u2981 Sanare",
        loadComponent: () => import("./chunk-NPTMVDDV.js").then((m) => m.NewProgramStepperComponent)
      },
      {
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-O57O6E4T.js").then((m) => m.UserEditFormComponent)
      }
    ]
  },
  {
    ...
    loadChildren: () => (
      ...
      import("./chunk-2D5Z2INU.js").then((m) => m.usersRoutes)
    )
  },
  /*   {
    path: 'print',
    title: 'Print template program ⦁ Sanare',
    loadComponent: () =>
      import('./pages/programs/print-template/print-template.component').then(
        m => m.PrintTemplateComponent,
      ),
  }, */
  {
    path: "**",
...
// apps/sanare-app/src/app/app.config.ts
var appConfig = {
  providers: [
