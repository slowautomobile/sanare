import { ClientFullEditFormComponent, ClientFullEditProgramsComponent, ClientsService, DeleteConfirmationDialogComponent, MatDialog, PageToolbarComponent, ShareClientsDataService, ShareStateService } from "./chunk-AZCPHFRJ.js";
import "./chunk-BMXRH6OH.js";
import "./chunk-7Q5ROX6O.js";
import { ActivatedRoute, MatSnackBar, Router, SharedResizeObserver } from "./chunk-A2XSFK7T.js";
import { MAT_RIPPLE_GLOBAL_OPTIONS, MatRipple, _StructuralStylesLoader } from "./chunk-ETCGSIPQ.js";
import "./chunk-N7W276PV.js";
import "./chunk-NCTODK62.js";
import { CdkPortal, CdkPortalOutlet, CdkScrollable, FormBuilder, FormControl, FormGroupDirective, FormsModule, NgControlStatusGroup, ReactiveFormsModule, TemplatePortal, Validators, ViewportRuler, ɵNgNoValidate } from "./chunk-LFO7H5VY.js";
import "./chunk-6KEP5RK3.js";
import "./chunk-CV435JUL.js";
import { CdkMonitorFocus, CdkObserveContent, Directionality, ENTER, FocusKeyManager, FocusMonitor, MatCommonModule, Platform, SPACE, _CdkPrivateStyleLoader, _IdGenerator, _bindEventWithOptions, hasModifierKey } from "./chunk-VZWK6WXM.js";
import { ANIMATION_MODULE_TYPE, BehaviorSubject, ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChild, ContentChildren, Directive, EMPTY, ElementRef, EventEmitter, HostAttributeToken, InjectionToken, Injector, Input, Location, NgModule, NgZone, Observable, Output, QueryList, Renderer2, Subject, Subscription, TemplateRef, ViewChild, ViewChildren, ViewContainerRef, ViewEncapsulation, __spreadProps, __spreadValues, afterNextRender, booleanAttribute, debounceTime, filter, forwardRef, inject, lastValueFrom, merge, numberAttribute, of, setClassMetadata, skip, startWith, switchMap, takeUntil, timer, ɵsetClassDebugInfo, ɵɵInheritDefinitionFeature, ɵɵNgOnChangesFeature, ɵɵProvidersFeature, ɵɵadvance, ɵɵattribute, ɵɵclassMap, ɵɵclassProp, ɵɵconditional, ɵɵcontentQuery, ɵɵdefineComponent, ɵɵdefineDirective, ɵɵdefineInjector, ɵɵdefineNgModule, ɵɵelement, ɵɵelementEnd, ɵɵelementStart, ɵɵgetCurrentView, ɵɵgetInheritedFactory, ɵɵlistener, ɵɵloadQuery, ɵɵnextContext, ɵɵprojection, ɵɵprojectionDef, ɵɵproperty, ɵɵqueryRefresh, ɵɵreference, ɵɵrepeater, ɵɵrepeaterCreate, ɵɵrepeaterTrackByIdentity, ɵɵresetView, ɵɵrestoreView, ɵɵstyleProp, ɵɵtemplate, ɵɵtext, ɵɵtextInterpolate, ɵɵviewQuery } from "./chunk-TTKC63AX.js";
...
// apps/sanare-app/src/app/pages/clients/client-form/client-form.component.ts
function ClientFormComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "ui-client-full-edit-form", 7);
  }
  if (rf & 2) {
    ɵɵproperty("isClient", true);
  }
}
function ClientFormComponent_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "ui-client-full-edit-programs");
  }
}
var ClientFormComponent = class _ClientFormComponent {
  constructor() {
  ...
  _checkEditMode() {
    this.currentClientId = this.route.snapshot.paramMap.get("id");
    if (this.currentClientId) {
      ...
      this.clientsService.getClient(this.currentClientId).subscribe({
        next: client => {
          ...
          this.form.get("clientInfo.address.street")?.setValue(client.address?.street);
          this.form.get("clientInfo.address.streetNumber")?.setValue(client.address?.streetNumber);
          this.form.get("clientInfo.address.city")?.setValue(client.address?.city);
          this.form.get("clientInfo.address.zipCode")?.setValue(client.address?.zipCode);
          this.form.get("clientInfo.address.country")?.setValue(client.address?.country);
          const programsArray = this.form.get("programs");
  ...
  _createClient(client) {
    const subscription = this.clientsService.createClient(client).subscribe(client2 => {
      this._snackBar.open("Patient erstellt", "", {
        duration: 2e3,
        panelClass: ["custom-snackbar-style"]
      });
      lastValueFrom(timer(1e3)).then(() => {
        ...
        this.router.navigateByUrl(`clients/form/${client2.id}`);
      });
    });
    this.subscriptions.add(subscription);
  }
  _updateClient(client, currentClientId) {
    const subscription = this.clientsService.updateClient(client, currentClientId).subscribe({
      next: createdClient => {
        console.log(createdClient);
        this._snackBar.open("Patient aktualisiert", "", {
          duration: 2e3,
          panelClass: ["custom-snackbar-style"]
        });
        lastValueFrom(timer(1e3)).then(() => {
  ...
  openDeleteConfirmationDialog(clientId) {
    console.log(clientId);
    const dialogRef = this.dialog.open(DeleteConfirmationDialogComponent, {
      width: "312px",
      data: {
        title: "Ausgew\xE4hlten Patienten l\xF6schen?",
        message: "Durch das L\xF6schen des ausgew\xE4hlten Patienten wird er aus Ihrem Konto entfernt."
      },
  ...
  deleteClient(clientId) {
    const subscription = this.clientsService.deleteClient(clientId).subscribe({
      next: () => {
        this._snackBar.open("Patient gel\xF6scht", "", {
          duration: 2e3,
          panelClass: ["custom-snackbar-style"]
        });
  ...
  static {
    this.ɵfac = function ClientFormComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ClientFormComponent)();
    };
  }
  static {
    this.ɵcmp = /* @__PURE__ */ɵɵdefineComponent({
      type: _ClientFormComponent,
      selectors: [["sanareapp-client-form"]],
      decls: 8,
      vars: 7,
      consts: () => {
        let i18n_0;
        if (false) {
          const MSG_EXTERNAL_ClientForm_tabGeneralLabel$$APPS_SANARE_APP_SRC_APP_PAGES_CLIENTS_CLIENT_FORM_CLIENT_FORM_COMPONENT_TS_0 = goog.getMsg("General");
          i18n_0 = MSG_EXTERNAL_ClientForm_tabGeneralLabel$$APPS_SANARE_APP_SRC_APP_PAGES_CLIENTS_CLIENT_FORM_CLIENT_FORM_COMPONENT_TS_0;
        } else {
          i18n_0 = "Allgemein";
        }
        let i18n_1;
        if (false) {
          const MSG_EXTERNAL_ClientForm_tabProgramsLabel$$APPS_SANARE_APP_SRC_APP_PAGES_CLIENTS_CLIENT_FORM_CLIENT_FORM_COMPONENT_TS_1 = goog.getMsg("Programs");
          i18n_1 = MSG_EXTERNAL_ClientForm_tabProgramsLabel$$APPS_SANARE_APP_SRC_APP_PAGES_CLIENTS_CLIENT_FORM_CLIENT_FORM_COMPONENT_TS_1;
        } else {
          i18n_1 = "Programme";
        }
        return [[3, "cancelEvent", "submitEvent", "deleteEvent", "cancelButton", "submitButton", "pageType", "editMode", "itemName"], [1, "client-form-wrapper"], [3, "formGroup"], ["mat-stretch-tabs", "false", "animationDuration", "0ms"], ["label", i18n_0, "bodyClass", "tab-content"], ["matTabContent", ""], ["label", i18n_1, 3, "disabled"], [3, "isClient"]];
      },
      template: function ClientFormComponent_Template(rf, ctx) {
        if (rf & 1) {
          ɵɵelementStart(0, "ui-page-toolbar", 0);
          ɵɵlistener("cancelEvent", function ClientFormComponent_Template_ui_page_toolbar_cancelEvent_0_listener() {
            return ctx.onBack();
          })("submitEvent", function ClientFormComponent_Template_ui_page_toolbar_submitEvent_0_listener() {
            return ctx.onSubmit();
          })("deleteEvent", function ClientFormComponent_Template_ui_page_toolbar_deleteEvent_0_listener() {
            return ctx.openDeleteConfirmationDialog(ctx.currentClientId);
          });
          ɵɵelementEnd();
          ɵɵelementStart(1, "div", 1)(2, "form", 2)(3, "mat-tab-group", 3)(4, "mat-tab", 4);
          ɵɵtemplate(5, ClientFormComponent_ng_template_5_Template, 1, 1, "ng-template", 5);
          ɵɵelementEnd();
          ɵɵelementStart(6, "mat-tab", 6);
          ɵɵtemplate(7, ClientFormComponent_ng_template_7_Template, 1, 0, "ng-template", 5);
          ɵɵelementEnd()()()();
        }
        if (rf & 2) {
          ɵɵproperty("cancelButton", true)("submitButton", true)("pageType", "client")("editMode", true)("itemName", ctx.clientInfo().clientName);
          ɵɵadvance(2);
          ɵɵproperty("formGroup", ctx.form);
          ɵɵadvance(4);
          ɵɵproperty("disabled", ctx.clientInfo().clientName.length === 0);
        }
      },
      dependencies: [PageToolbarComponent, ClientFullEditFormComponent, ClientFullEditProgramsComponent, FormsModule, ɵNgNoValidate, NgControlStatusGroup, ReactiveFormsModule, FormGroupDirective, MatTabGroup, MatTab, MatTabContent],
      encapsulation: 2
    });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(ClientFormComponent, {
    className: "ClientFormComponent",
    filePath: "apps/sanare-app/src/app/pages/clients/client-form/client-form.component.ts",
    lineNumber: 52
  });
})();
export { ClientFormComponent };
/**i18n:e33dda9241aa0d3f81605574177eca303a560132442e585b3107f4f1b4a47a86*/
//# sourceMappingURL=chunk-CCSTJZQO.js.map