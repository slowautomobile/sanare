import { ClientsService, MAT_DIALOG_DATA, MatDialogActions, MatDialogRef, MatDialogTitle, OverlayScrollbarsComponent, OverlayscrollbarsModule, ProgramsService, ShareClientsDataService, ThemeManagerService } from "./chunk-M5HED6BD.js";
...
import { ClientsProgressComponent } from "./chunk-FI4CVZOF.js";
import "./chunk-BMXRH6OH.js";
import { MatButton } from "./chunk-ETCGSIPQ.js";
import { MatIcon } from "./chunk-NCTODK62.js";
import { DefaultValueAccessor, FormBuilder, FormControlName, FormGroupDirective, FormsModule, NgControlStatus, NgControlStatusGroup, ReactiveFormsModule, Validators, ɵNgNoValidate } from "./chunk-LFO7H5VY.js";
import "./chunk-CV435JUL.js";
import "./chunk-VZWK6WXM.js";
import { Subscription, inject, of, ɵsetClassDebugInfo, ɵɵadvance, ɵɵdefer, ɵɵdeferOnIdle, ɵɵdefineComponent, ɵɵelement, ɵɵelementEnd, ɵɵelementStart, ɵɵi18n, ɵɵlistener, ɵɵnextContext, ɵɵpipe, ɵɵpipeBind1, ɵɵproperty, ɵɵtemplate, ɵɵtext, ɵɵtextInterpolate1 } from "./chunk-TTKC63AX.js";

// libs/clients/src/lib/components/show-client-modal/show-client-modal.component.ts
var ShowClientModalComponent_Defer_24_DepsFn = () => [import("./chunk-Z6I3SX4T.js").then(m => m.ClientsProgressComponent), import("./chunk-6M2EGYFU.js").then(m => m.AsyncPipe)];
...
var ShowClientModalComponent = class _ShowClientModalComponent {
  constructor() {
    ...
    this.fullEditButtonString = "Vollst\xE4ndige Bearbeitung";
    ...
    this.ɵcmp = /* @__PURE__ */ɵɵdefineComponent({
      ...
      consts: () => {
        ...
        if (false) {
          ...
          i18n_0 = "Geben Sie den Vornamen des Patienten ein";
        }
        let i18n_1;
        if (false) {
          ...
          i18n_1 = "Geben Sie den Nachnamen des Patienten ein";
        }
        let i18n_2;
        if (false) {
          ...
          i18n_2 = "Geben Sie die E-Mail-Adresse des Patient ein";
        }
        let i18n_3;
        if (false) {
          ...
          i18n_3 = "Geben Sie die Telefonnummer des Patienten ein";
        }
        let i18n_4;
        if (false) {
...
//# sourceMappingURL=chunk-7AOSA2FU.js.map