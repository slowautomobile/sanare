import { MatSlideToggle } from "./chunk-IBUBOW3U.js";
import { MatDrawer, MatDrawerContainer, MatDrawerContent } from "./chunk-FYBTHQM6.js";
...
import { ActivatedRoute, CdkTextareaAutosize, ErrorStateMatcher, LocalstorageService, MAT_FORM_FIELD, MAT_INPUT_VALUE_ACCESSOR, MatError, MatFormField, MatFormFieldControl, MatHint, MatInput, MatLabel, MatPrefix, MatSnackBar, Router, UsersService, _ErrorStateTracker } from "./chunk-A2XSFK7T.js";
import { MatButton, MatButtonModule, MatIconButton, MatRipple, MatRippleModule, _StructuralStylesLoader } from "./chunk-ETCGSIPQ.js";
import "./chunk-N7W276PV.js";
import { MatIcon, MatIconModule } from "./chunk-NCTODK62.js";
import { CdkPortalOutlet, CdkScrollableModule, ComponentPortal, ControlContainer, DefaultValueAccessor, FlexibleConnectedPositionStrategy, FormBuilder, FormControl, FormControlName, FormGroup, FormGroupDirective, FormGroupName, FormsModule, MaxLengthValidator, NG_VALIDATORS, NG_VALUE_ACCESSOR, NgControl, NgControlStatus, NgControlStatusGroup, NgForm, Overlay, OverlayConfig, OverlayModule, PortalModule, ReactiveFormsModule, TemplatePortal, Validators, coerceStringArray, ɵNgNoValidate } from "./chunk-LFO7H5VY.js";
import "./chunk-6KEP5RK3.js";
import "./chunk-CV435JUL.js";
import { A11yModule, BACKSPACE, BidiModule, CdkMonitorFocus, CdkTrapFocus, DOWN_ARROW, Directionality, END, ENTER, ESCAPE, FocusKeyManager, FocusMonitor, HOME, LEFT_ARROW, MatCommonModule, PAGE_DOWN, PAGE_UP, Platform, RIGHT_ARROW, SPACE, UP_ARROW, _CdkPrivateStyleLoader, _IdGenerator, _VisuallyHiddenLoader, _bindEventWithOptions, _getFocusedElementPierceShadowDom, hasModifierKey } from "./chunk-VZWK6WXM.js";
...
var ExercisesListComponent_Defer_6_DepsFn = () => [import("./chunk-OCDFFXX5.js").then(m => m.ExercisesGridComponent)];
var ExercisesListComponent_Defer_16_DepsFn = () => [import("./chunk-UCSLXHAX.js").then(m => m.SelectedExercisesListComponent)];
  ...
  static {
    this.ɵcmp = /* @__PURE__ */ɵɵdefineComponent({
      ...
      consts: () => {
        ...
        return [i18n_0, [1e3], ["cdkDropListGroup", ""], [1, "main-page-wrappper"], [1, "exercise-content-wrapper"], [3, "listOptionValue"], [1, "selected-exercises-list-wrapper"], [1, "selected-exercises"], [1, "title", "mat-title-medium-margin-plus"], ["overlay-scrollbars", "", 1, "selected-exercises-container", 3, "options", "defer"], [3, "exercises"], [1, "grid-container-placeholder"], [1, "exercise-cards-placeholder"], [1, "exercise-card-skeleton"], [1, "background-wrapper-placeholder"], [1, "main-wrap-placeholder"]];
      },
...
//# sourceMappingURL=chunk-V6QZ77Y7.js.map