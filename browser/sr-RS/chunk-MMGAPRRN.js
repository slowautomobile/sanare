import { CdkDrag, CdkDragPlaceholder, CdkDropList, DropListTransferItemService, ExerciseModalComponent, ExercisesService, MatDialog, MatProgressSpinner, MatProgressSpinnerModule, OverlayScrollbarsComponent, OverlayscrollbarsModule, SelectedExercisesService, ShareStateService, ThemeManagerService } from "./chunk-M5HED6BD.js";
import "./chunk-7Q5ROX6O.js";
import { LocalstorageService, UsersService } from "./chunk-A2XSFK7T.js";
import "./chunk-N7W276PV.js";
import { VideoPlayerComponent } from "./chunk-6KEP5RK3.js";
import "./chunk-BMXRH6OH.js";
import { MatIconButton, MatMiniFabButton } from "./chunk-ETCGSIPQ.js";
import { MatIcon, MatTooltip } from "./chunk-NCTODK62.js";
import "./chunk-LFO7H5VY.js";
import "./chunk-CV435JUL.js";
import "./chunk-VZWK6WXM.js";
import { AsyncPipe, CommonModule, NgClass, NgStyle, Subscription, __spreadProps, __spreadValues, debounceTime, fromEvent, inject, map, output, startWith, ɵsetClassDebugInfo, ɵɵadvance, ɵɵconditional, ɵɵdefer, ɵɵdeferOnIdle, ɵɵdefineComponent, ɵɵelement, ɵɵelementEnd, ɵɵelementStart, ɵɵgetCurrentView, ɵɵi18n, ɵɵlistener, ɵɵnextContext, ɵɵpipe, ɵɵpipeBind1, ɵɵproperty, ɵɵreference, ɵɵrepeater, ɵɵrepeaterCreate, ɵɵresetView, ɵɵrestoreView, ɵɵtemplate, ɵɵtext, ɵɵtextInterpolate, ɵɵtextInterpolate1 } from "./chunk-TTKC63AX.js";
    ...
    this.ɵcmp = /* @__PURE__ */ɵɵdefineComponent({
      ...
      template: function ExercisesGridComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          ɵɵrepeaterCreate(5, ExercisesGridComponent_For_6_Template, 5, 1, null, null, _forTrack0);
          ɵɵelementEnd()();
        }
        if (rf & 2) {
      ...
      styles: [".noExercisesFound[_ngcontent-%COMP%]{text-align:center;margin:32px 0}.fetchingDataSpinner[_ngcontent-%COMP%]{position:absolute;display:flex;align-items:center;justify-content:center;left:4px;right:4px;top:4px;width:calc(100% - 20px);height:100%;border-top-left-radius:16px;border-top-right-radius:16px}\n/*# sourceMappingURL=exercises-grid.component-U6R3AMC6.css.map */"]
    });
  }
};
(() => {
...
//# sourceMappingURL=chunk-MMGAPRRN.js.map