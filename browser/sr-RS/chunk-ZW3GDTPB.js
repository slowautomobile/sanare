...
var LoginComponent = class _LoginComponent {
  ...
  onSubmitGuest() {
    ...
    this.usersService.loginAsGuest().subscribe({
      ...
      error: err => {
        this._snackBar.open("Previ\u0161e poku\u0161aja prijavljivanja. Poku\u0161ajte ponovo za 15 minuta.", "", {
          duration: 2e3,
    ...
    this.ɵcmp = /* @__PURE__ */ɵɵdefineComponent({
      ...
      consts: () => {
        ...
        if (false) {
          ...
          i18n_0 = "Unesite korisni\u010Dko ime/e-po\u0161tu";
        }
        let i18n_1;
        if (false) {
        ...
        if (false) {
          ...
          i18n_9 = "Molimo Vas da unesete va\u017Ee\u0107u e-po\u0161tu";
        }
        let i18n_10;
        if (false) {
